...
_page("SELECT id FROM tb_orders WHERE deal='0'",7);
$_result = _query("SELECT * FROM tb_orders WHERE deal='0' LIMIT $_pagenum,$_pagesize");
?>
		...
		<tr><th>商品信息</th><th>商品名称</th><th>单价</th><th>数量</th></tr>
			...
			<tr class="orders">
				<td colspan="4">
					...
					<span class="deliver">[<a href="deliver.php?action=deliver&id=<?php echo $_html['id']?>">发货处理</a>]	</span>
				</td>			
			</tr>
			<?php 
