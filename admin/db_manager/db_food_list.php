...
$_sortid=$_GET['sort'];
_page("SELECT id FROM tb_food",10);
$_result = _query("SELECT id,name,pic,price,stock FROM tb_food WHERE sort='$_sortid'");
?>
...
<div id="member">
	...
	<div id="food_list">
		...
		<tr><th>图片</th><th>名称</th><th>价格</th><th>库存量</th><th>操作</th></tr>
			...
			?>
			<tr>
				<td><a href="db_food_modify.php?id=<?php echo $_html['id']?>">
				...
				<td>
					...
					<form method ="post" action="db_food_count_add.php?ids=<?php echo $_html['id']?>" >
				...
				<td>[<a href="db_food_delete.php?action=delete&id=<?php echo $_html['id']?>">删除</a>]</td>
			</tr>
			<?php 
				}
			?>
